...
App = 
{
  ...
  loadContract: function (){
    ...
    $.getJSON('evote.json', function(data) {
      // Get the necessary contract artifact file and instantiate it with @truffle/contract
      var AdoptionArtifact = data;
      App.contracts.Adoption = TruffleContract(AdoptionArtifact); //creates an instance of the contract we can interact with.
    
      // Set the provider for our contract, set its web3 provider 
      App.contracts.Adoption.setProvider(App.web3Provider);
    
      // // Use our contract to retrieve and mark the adopted pets
      // return App.markAdopted();
      // App.voting = App.contracts.evote.deployed()
    });   
  ...
  bindEvents: function() {
    var btn = document.getElementById("btn-adopt");
